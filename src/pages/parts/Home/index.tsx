...
<Typography sx={{color:'#325CD9',fontFamily:'Filson',fontSize:49, fontWeight:700,lineHeight:'48px',padding:'0 12rem 0 0'}} component='h1'>
Criamos arte Geramos Resultado
</Typography>
<Typography component='p' sx={{color:"#404144",fontFamily:'Filson', fontSize:'1.9375rem',margin:'1.75rem 0',fontWeight:300,padding:'0 8rem 0 0',lineHeight:'40px'}}>
...
<Box sx={{
    ...
    <img width={'100%'} src="img/Image1.png" alt="Image Home" />
            ...
            <Box sx={{padding:'10px'}}>
                <Typography sx={{fontSize:'2.4375rem' ,color:'#404144',fontFamily:'Filson',textAlign:'center',fontWeight:300,lineHeight:'48px'}} component='p'>
